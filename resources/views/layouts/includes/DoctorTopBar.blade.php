<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><span>Doctor</span> Dashboard</a>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="{{ route('doctors.dashboard') }}"><em class="fa fa-dashboard">&nbsp;</em>
                Dashboard</a></li>
       ...
       {{-- <li class="parent ">
            ...
            <ul class="children collapse" id="sub-item-1">
                <li><a class="" href="{{ route('doctors.patients.index') }}">
